...
2. You should be taken to the Profile page, where you can access your new API key.
...
You can do this next step on either a phone or a computer, but it will be easier on the same computer that you performed the above steps on since you will be able to copy-paste the API key.
